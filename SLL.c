...
void insertion(struct node** head_ref, int new_data, int position)
{
	...
	if(current !=NULL){
		...
		printf("Insertion Location is greater than the Length of the Linked List \n");
		return;
	}
...
void deletion(struct node** head_ref, int position)
{
	...
	if(current->next !=NULL){
		...
		printf("Deletion Location is greater than the Length of the Linked List \n");
		return;
	}
...
/* We will print the linked list while traversing*/
